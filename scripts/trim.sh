...
function trim {
    trimmomatic PE \
    -threads 1 -phred33 \
    data/SRR22746934_1.fastq \
    data/SRR22746934_2.fastq \
    data/trimmed/Paired/Ecoli.R1.paired.fastq \
    data/trimmed/Ecoli.R1.unpaired.fastq \
    data/trimmed/Paired/Ecoli.R2.paired.fastq \
    data/trimmed/Ecoli.R2.unpaired.fastq \
    HEADCROP:0 \
